...
<body>
    <div class="container edit-user-container m-auto w-75 border rounded mt-5 p-2 shadow-lg">
        <div class="<?php echo $class; ?>" role="alert">
            <p><?php echo ($message) ?? ''; ?></p>
            <p><?php echo ($uploadError) ?? ''; ?></p>
        </div>

        <h2>Update <?php echo $f_name . " " . $l_name . "'s " ?>details</h2>
        <img class='img-thumbnail updateImg rounded-circle' src='pictures/<?php echo $data['picture'] ?>'
            alt="<?php echo $f_name ?>">
