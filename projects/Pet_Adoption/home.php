...
<body>
    <div class="home-container">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="#">F.A.Qs</a></li>
                            </ul>
                        </li>
                        <!--  FOR USERS ONLY -->
                        <li class="nav-item">
                            <a class="nav-link" href="pets/your_pets.php">Your Pets</a>
                        </li>
                        <!-- Logout nav-link -->
                        <li class="nav-item">
        ...
        <div class="container mt-3">
            <div class="hero rounded p-3 text-center">
                <img class="userImage rounded-circle" src="pictures/<?php echo $row1['picture']; ?>"
                    alt="<?php echo $row1['first_name']; ?>">
                <p class="text-white">Hi <?php echo $row1['first_name']; ?></p>
            </div>
            <a class="nav-link btn btn-dark border rounded w-25 m-auto mt-1" href="logout.php?logout">Sign Out</a>
            <a class="nav-link btn btn-warning border rounded w-25 m-auto"
                href="update.php?id=<?php echo $_SESSION['user'] ?>">Update your profile</a>
        </div>
        <!-- Table 1 All-->
